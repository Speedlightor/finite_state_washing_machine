...
architecture Behavioral of washing_machine_tb is
    ...
    constant KEY_DELAY: time := CLK_PERIOD*3; -- минимальное время нажатия кнопки для принятия решения о её нажатии 
...
begin
    ...
    begin
        ...
        -- Тест 6. Попытка старта стирки без наличия воды на входе машины 
        report "TEST 6: start washing without water";
        start <= '1';
        wait for 2 * KEY_DELAY;
        start <= '0';
